...
dataPath = 'D:\Project\QoA\QoA-of-synthesized-view\data\Saliency\';
rootPath = 'D:\Project\QoA\QoA-of-synthesized-view\data\Saliency\Result\';
%% input paths
rgbPath =strcat(dataPath, 'Image/');
...
%     AngleDepth = atand(6.3/93)-atand(6.3./(93-meanDepth));
    ...
    smap=[DepthContrast';DepthDiffusion';ColorDiffusion';wCtr';lbeSM']';
